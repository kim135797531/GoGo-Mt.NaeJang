...
import org.kdm.gogomtnaejang.reality.CameraMixContext;
...
class LocationMgrImpl implements LocationFinder {
	...
	public LocationMgrImpl(CameraMixContext mixContext) {
	...
	public Location getCurrentLocation() {
		if (curLoc == null) {
			CameraMixActivity mixView = mixContext.getActualMixView();
